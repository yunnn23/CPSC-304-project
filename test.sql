...
CREATE TABLE Contains(
	...
	FacilityID CHAR(5),
	FacilityName VARCHAR(20),
	PRIMARY KEY (SportsCenterLocation, facilityID, FacilityName),
	FOREIGN KEY (SportsCenterLocation) REFERENCES SportsCenter ON DELETE CASCADE,
		-- ON UPDATE CASCADE
	FOREIGN KEY (FacilityID, FacilityName) REFERENCES Facility ON DELETE CASCADE
		-- ON UPDATE CASCADE
);
...
-- Member
INSERT INTO Member VALUES('M0001', '0000 W 1th ave, Vancouver', '0000000000', 'Michael', 'Jordan', TO_DATE('1963/02/17', 'yyyy/mm/dd'), 'jordan.michael@gmail.com');

INSERT INTO Member VALUES('M0002', '1111 W 2th ave, Vancouver', '1111111111', 'Lionel', 'Messi', TO_DATE('1987/06/24','yyyy/mm/dd'), 'messi.lionel@gmail.com');

INSERT INTO Member VALUES('M0003', '2222 W 3th ave, Vancouver', '2222222222', 'Seri', 'Park', TO_DATE('1977/09/28','yyyy/mm/dd'), 'prak.seri@gmail.com');	

INSERT INTO Member VALUES('M0004', '3333 W 4th ave, Vancouver', '3333333333', 'Kathleen', 'Ledecky', TO_DATE('1997/03/17','yyyy/mm/dd'), 'ledecky.kethleen@gmail.com');

INSERT INTO Member VALUES('M0005', '4444 W 5th ave, Vancouver', '4444444444', 'Conner', 'McDavid', TO_DATE('1997/01/13','yyyy/mm/dd'), 'mcdavid.conner@gmail.com');	

INSERT INTO Member VALUES('M0006', '5555 W 6th ave, Vancouver', '5555555555', 'Spag', 'Moss', TO_DATE('2015/01/13','yyyy/mm/dd'), 'spag.moss@gmail.com'); 	
...
-- Facility
INSERT INTO Facility VALUES('SW001', 'Swimming Pool', '5000');

INSERT INTO Facility VALUES('SW002', 'Swimming Pool', '6700');

INSERT INTO Facility VALUES('SW003', 'Swimming Pool', '5000');

INSERT INTO Facility VALUES('SW004', 'Swimming Pool', '6700');

INSERT INTO Facility VALUES('SW005', 'Swimming Pool', '6700');

INSERT INTO Facility VALUES('TC001', 'Tennis Court', '4800');

INSERT INTO Facility VALUES('TC002', 'Tennis Court', '4800');

INSERT INTO Facility VALUES('TC003', 'Tennis Court', '4800');

INSERT INTO Facility VALUES('TC004', 'Tennis Court', '4800');

INSERT INTO Facility VALUES('TC005', 'Tennis Court', '4800');

INSERT INTO Facility VALUES('IR001', 'Ice Rink', '3500');

INSERT INTO Facility VALUES('IR002', 'Ice Rink', '3200');

INSERT INTO Facility VALUES('IR003', 'Ice Rink', '3000');

INSERT INTO Facility VALUES('IR004', 'Ice Rink', '3300');

INSERT INTO Facility VALUES('IR005', 'Ice Rink', '3000');

INSERT INTO Facility VALUES('BK001', 'Ice Rink', '2000');

-- SwimmingPool
INSERT INTO SwimmingPool VALUES('SW001', 'Swimming Pool', '1.2m');

INSERT INTO SwimmingPool VALUES('SW002', 'Swimming Pool', '3m');

INSERT INTO SwimmingPool VALUES('SW003', 'Swimming Pool', '5m');

INSERT INTO SwimmingPool VALUES('SW004', 'Swimming Pool', '1.2m');

INSERT INTO SwimmingPool VALUES('SW005', 'Swimming Pool', '2.5m');

-- TennisCourt
INSERT INTO TennisCourt VALUES('TC001', 'Tennis Court', 'Indoor');

INSERT INTO TennisCourt VALUES('TC002', 'Tennis Court', 'Indoor');

INSERT INTO TennisCourt VALUES('TC003', 'Tennis Court', 'Outdoor');

INSERT INTO TennisCourt VALUES('TC004', 'Tennis Court', 'Indoor');

INSERT INTO TennisCourt VALUES('TC005', 'Tennis Court', 'Outdoor');

-- IceRink
INSERT INTO IceRink VALUES('IR001', 'Ice Rink', '25F');

INSERT INTO IceRink VALUES('IR002', 'Ice Rink', '22F');

INSERT INTO IceRink VALUES('IR003', 'Ice Rink', '24F');

INSERT INTO IceRink VALUES('IR004', 'Ice Rink', '20F');

INSERT INTO IceRink VALUES('IR005', 'Ice Rink', '22F');

-- CONTAINS
INSERT INTO Contains VALUES('UBC', 'SW001', 'Swimming Pool');

INSERT INTO Contains VALUES('UBC', 'TC002', 'Tennis Court');

INSERT INTO Contains VALUES('UBC', 'IR002', 'Ice Rink');

INSERT INTO Contains VALUES('Kitsilano', 'SW002', 'Swimming Pool');

INSERT INTO Contains VALUES('South Granville', 'TC001', 'Tennis Court');

INSERT INTO Contains VALUES('Richmond', 'IR001', 'Ice Rink');

INSERT INTO Contains VALUES('Sunset', 'IR005', 'Ice Rink');
